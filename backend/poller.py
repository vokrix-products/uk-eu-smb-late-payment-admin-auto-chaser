...
import processor  # processor.py has process_file(bytes)
...
def poll():
    ...
    try:
        ...
        # Run processor (returns list of extraction records)
        records = processor.process_file(input_path.read_bytes())
